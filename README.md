...
## View live preview [here](https://tamoghnamondalportfolio.netlify.app/).
...
### Then, Customize data in the `utils/data` [folder](https://github.com/rishiTamoghna17/developer-portfolio/tree/master/utils/data).

Eg:

```javascript
export const personalData = {
  name: "Tamoghna Mondal",
  profile: '/profile.png',
  designation: "Software Developer",
  description: "My name is Tamoghna Mondal. I am a professional and enthusiastic programmer in my daily life. I am a quick learner with a self-learning attitude. I love to learn and explore new technologies and am passionate about problem-solving. I love almost all the stacks of web application development and love to make the web more open to the world. My core skill is based on JavaScript and I love to do most of the things using JavaScript. I am available for any kind of job opportunity that suits my skills and interests.",
  email: 'tamoghna171099@gmail.com',
  phone: '+91-7001586476',
  address: 'Gobardanga,North 24 Parganas, West Bengal, 743273',
  github: 'https://github.com/rishiTamoghna17',
  facebook: 'https://www.facebook.com/profile.php?id=100006366585672',
  linkedIn: 'https://www.linkedin.com/in/tamoghna-mondal-469804190/',
  twitter: 'https://x.com/evil_lau8r',
  leetcode: "https://leetcode.com/rishiTamoghna17/",
  devUsername: "rishitamoghna17",
  resume:  "..."
};
```
